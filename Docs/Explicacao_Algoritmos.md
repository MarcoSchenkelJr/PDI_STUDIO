...
* **Threshold (Limiarização / Binarização):** 
  O objetivo é transformá-la estritamente em Preto Puro (0) ou Branco Puro (255). Nós escolhemos um valor de "corte" na balança (ex: 128). O laço `for` pergunta para cada pixel: "Sua cor é maior que 128?". Se sim, ele vira 255 (Branco). Se não, vira 0 (Preto).
* **Brilho e Contraste:** 
